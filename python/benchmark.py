...
def run_benchmarks(config, demo=True):
    N_trials = 100
    N_test = 10000
    ...
    models = [lambda: SqErrNetwork(),
              lambda: QuantileNetwork(quantiles=quantiles, config=config)]
...
if __name__ == '__main__':
    ...
    np.set_printoptions(precision=2, suppress=True) # float point, keep digit
    import warnings
